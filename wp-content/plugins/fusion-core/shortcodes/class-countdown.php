	...
	public function render( $args, $content = '' ) {
		...
		$html = sprintf( '<div %s>', FusionCore_Plugin::attributes( 'countdown-shortcode' ) );
			...
			$html .= sprintf( '<div %s>', FusionCore_Plugin::attributes( 'countdown-shortcode-counter-wrapper' ) );
				...
				$dashes = array (
					array( 'show' => $show_weeks, 'class' => 'weeks', 'shortname' => __( 'Semaines', 'fusion-core' ), 'longname' => __( 'Weeks', 'fusion-core' ) ),
					array( 'show' => 'yes', 'class' => 'days', 'shortname' => __( 'Jours', 'fusion-core' ), 'longname' => __( 'Days', 'fusion-core' ) ),
					array( 'show' => 'yes', 'class' => 'hours', 'shortname' => __( 'Heurs', 'fusion-core' ), 'longname' => __( 'Hours', 'fusion-core' ) ),
					array( 'show' => 'yes', 'class' => 'minutes', 'shortname' => __( 'Minutes', 'fusion-core' ), 'longname' => __( 'Minutes', 'fusion-core' ) ),
					array( 'show' => 'yes', 'class' => 'seconds', 'shortname' => __( 'Secondes', 'fusion-core' ), 'longname' => __( 'Seconds', 'fusion-core' ) )
				);
